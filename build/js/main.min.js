...
var _playVideo = require("./modules/play-video/play-video.js");
var _initTabs = require("./modules/tabs/init-tabs");
var _initSwiper = require("./modules/swiper/init-swiper.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    // initPlayVideo();
    setTimeout(function () {
      return (0, _playVideo.initPlayVideo)();
    }, 3000);
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/play-video/play-video.js":11,"./modules/swiper/init-swiper.js":12,"./modules/tabs/init-tabs":13,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
...
var initPlayVideo = function initPlayVideo() {
  var playButton = document.querySelector('[data-play-video-button]');
  var coverImage = document.querySelector('[data-cover4video]');
  var videoUrl = document.querySelector('[data-video-player]').dataset.videoSrc;
  if (playButton && coverImage && videoUrl) {
    ...
    var endedVideo = function endedVideo() {
...
var staffSwiperNode = document.querySelector('.staff__swiper');
var reviewsSwiperNode = document.querySelector('.reviews__swiper');
var initSwiper = function initSwiper() {
  if (staffSwiperNode) {
    var staffSwiper = new _swiperBundle.default('.staff__swiper', {
      // eslint-disable-line
  ...
  if (reviewsSwiperNode) {
    var reviewsSwiper = new _swiperBundle.default('.reviews__swiper', {
      // eslint-disable-line
...
},{"../../vendor/swiper-bundle":19}],13:[function(require,module,exports){
"use strict";
