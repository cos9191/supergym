...
var initPlayVideo = function initPlayVideo() {
  function findVideos() {
    var videos = document.querySelectorAll('[data-video-player]');
    for (var i = 0; i < videos.length; i++) {
      setupVideo(videos[i]);
    }
  }
  function setupVideo(video) {
    var media = video.querySelector('[data-cover4video]');
    var button = video.querySelector('[data-play-video-button]');
    var id = video.getAttribute('data-video-src');
